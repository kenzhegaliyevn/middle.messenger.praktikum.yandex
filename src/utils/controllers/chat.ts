...
export default class ChatController {
    ...
    public async getChats() {
        ...
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_GETCHATS_SUCCEED, data);
        } catch (error) {
    ...
    public async createChat(inputs: Input[]) {
        ...
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_CREATECHAT_SUCCEED);
        } catch (error) {
    ...
    public async getChatToken(id: number) {
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_GETCHATTOKEN_SUCCEED, {
                id,
                token,
            });
    ...
    public async getChatUsers(chatId: number) {
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_GETCHATUSERS_SUCCEED, {
                chatId,
                users,
            });
    ...
    public async addChatUser(data: { userId: number, chatId: number }) {
        ...
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_ADDCHATUSER_SUCCEED);
        } catch (error) {
    ...
    public async deleteChatUser(data: { userId: number, chatId: number }) {
        ...
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_DELETECHATUSER_SUCCEED);
        } catch (error) {
    ...
    public async deleteChat(chatId: number) {
        ...
        try {
            ...
            GlobalEventBus.getInstance().EventBus.emit(GlobalEvents.ACTION_DELETECHAT_SUCCEED);
        } catch (error) {
